...
%%% The below paragraph may sit better in the first half of the chapter if not already covered
...
%% I don't think I need more on the wedge here as Gianni has probably gone into it in detail.
...
\begin{figure}
\begin{center}
    \includegraphics[width=0.5\textwidth]{Images/horizon.png}
\end{center}
