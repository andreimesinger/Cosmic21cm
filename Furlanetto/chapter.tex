...
\begin{figure}[]
\begin{center}
\includegraphics[width=0.5\textwidth]{Furlanetto/01x01-eps-converted-to}
\end{center}
...
\begin{figure}[]
\begin{center}
\includegraphics[width=0.6\textwidth]{Furlanetto/01x02}
\end{center}
...
\bibliography{Furlanetto/References}
