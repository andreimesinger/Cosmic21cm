...
\label{eq:sec:4}
\end{equation} 
whereas the undesired instrumental leakage between the two orthogonal polarized is represented by a ${\bf D}$ Jones matrix of the form:
\begin{equation}
    {\bf D} (t,\lambda) \equiv 
    \left[
    \begin{array}{cc}
...
Calibration of 21~cm observation is currently a very active research area focusing in a few main topics: 
%
\begin{itemize}
