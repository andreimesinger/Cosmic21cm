...
\item {\it Low Frequency Array (LOFAR, \cite{vanhaarlem13})}. LOFAR is an array of 40 stations located in The Nerthelands and several remote stations across Europe. Stations are formed by two types of receptors sensitive to the $30-90$ and $110-200$~MHz respectively. The $110-200$~MHz is the most sensitive to 21~cm observations and we will only consider its stations in this brief summary. 
Larger stations allow to better isolate sky regions where the foreground contamination is fainter (including polarized foregrounds), reduce wide field ionopsheric effects and foreground contamination - 
